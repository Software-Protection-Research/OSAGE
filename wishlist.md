...
- init_program und includes.h aus allen src files entfernen und wenn notwendig in den Tigress Container einbauen
...
- check src_strings/anagram when compiled giving a Segmentation Fault
