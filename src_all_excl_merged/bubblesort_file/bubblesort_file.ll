; ModuleID = '../src_all_excl_merged/bubblesort_file/bubblesort_file.c'
source_filename = "../src_all_excl_merged/bubblesort_file/bubblesort_file.c"
...
26:                                               ; preds = %16
  ...
  store %struct._IO_FILE* %28, %struct._IO_FILE** %12, align 8
...
34:                                               ; preds = %26
  ...
  %36 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* noundef %35, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* noundef %8)
  br label %37
...
53:                                               ; preds = %50, %46
  ...
  %55 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* noundef %54, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* noundef %8)
...
99:                                               ; preds = %85
  ...
  call void @bubblesort(i32* noundef %102, i32 noundef %103)
