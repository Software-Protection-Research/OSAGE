; ModuleID = '../src_all_excl_merged/fahrenheit2kelvin/fahrenheit2kelvin.c'
source_filename = "../src_all_excl_merged/fahrenheit2kelvin/fahrenheit2kelvin.c"
