; ModuleID = '../src_all_excl_merged/averagesum/averagesum.c'
source_filename = "../src_all_excl_merged/averagesum/averagesum.c"
...
define dso_local i32 @average_sum(i32 noundef %0) #0 {
...
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 {
  ...
  %17 = call i32 @average_sum(i32 noundef %16)
  store i32 %17, i32* %8, align 4
  %18 = load i32, i32* %8, align 4
  %19 = icmp eq i32 %18, -1643739139
