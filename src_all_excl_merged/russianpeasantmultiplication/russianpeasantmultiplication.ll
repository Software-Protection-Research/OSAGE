; ModuleID = '../src_all_excl_merged/russianpeasantmultiplication/russianpeasantmultiplication.c'
source_filename = "../src_all_excl_merged/russianpeasantmultiplication/russianpeasantmultiplication.c"
