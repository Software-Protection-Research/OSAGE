...
BEGIN-TIGRESS
{
  "Tigress": {
    ...
    "Version": "4.0.3,Operating system=Linux, Architecture=x86_64, Git hash=160206a9384ce66d70d440101bd31d811123d581, Date=2024-08-20T21:49:00:+0000",
    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Externs": [
          ...
          "__builtin_fmodf128", "global", "another"
        ],
        "New Types": [ "foo", "bar", "foo" ],
...
/* #pragma merger("0","/tmp/cil-OBADh_uS.i","") */
/* #pragma merger("0","/tmp/cil-XfyDPoIb.i","") */

/* BEGIN STRUCT-DECL foo LOC=test1.c:1 */
struct foo ;
/* END STRUCT-DECL foo LOC=test1.c:1 */

/* BEGIN STRUCT-DECL bar LOC=test2.c:1 */
struct bar ;
/* END STRUCT-DECL bar LOC=test2.c:1 */
...
/* BEGIN STRUCT bar LOC=test2.c:1 */
struct bar {
   int x ;
   struct bar *next ;
};
/* END STRUCT bar LOC=test2.c:1 */
...
/* BEGIN VARIABLE-DECL-EXTERN global LOC=test1.c:2 */
extern struct bar *global ;
/* END VARIABLE-DECL-EXTERN global LOC=test1.c:2 */
...
/* BEGIN STRUCT foo LOC=test2.c:6 */
struct foo {
   int y ;
};
/* END STRUCT foo LOC=test2.c:6 */

/* BEGIN VARIABLE-DECL-EXTERN another LOC=test2.c:9 */
extern struct foo another ;
/* END VARIABLE-DECL-EXTERN another LOC=test2.c:9 */
