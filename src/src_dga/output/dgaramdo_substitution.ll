...
17:                                               ; preds = %17, %1
  %18 = phi i64 [ 0, %1 ], [ %34, %17 ]
  %19 = phi i64 [ %15, %1 ], [ %30, %17 ]
  %20 = and i64 %19, 4294967295
  %21 = urem i64 %20, 26
  %22 = trunc i64 %21 to i8
  %23 = add nuw i8 %22, 97
  %24 = call noalias dereferenceable_or_null(2) ptr @malloc(i64 noundef 2) #17
  store i8 %23, ptr %24, align 1, !tbaa !16
  %25 = getelementptr inbounds i8, ptr %24, i64 1
  store i8 0, ptr %25, align 1, !tbaa !16
  %26 = call ptr @strcat(ptr noundef nonnull %2, ptr noundef nonnull dereferenceable(1) %24) #18
  %27 = mul i64 %16, %18
  %28 = mul i64 %27, %18
  %29 = xor i64 %28, %20
...
36:                                               ; preds = %17
  %37 = call i64 @strlen(ptr noundef nonnull %2)
  %38 = getelementptr inbounds i8, ptr %2, i64 %37
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %38, ptr noundef nonnull align 1 dereferenceable(5) @.str.2, i64 5, i1 false)
  %39 = getelementptr inbounds %struct.sSelf, ptr %0, i64 0, i32 3
  %40 = call ptr @strcpy(ptr noundef nonnull %39, ptr noundef nonnull %2) #18
  store i64 %7, ptr %5, align 8, !tbaa !15
  %41 = load i8, ptr %2, align 16, !tbaa !16
  store i8 %41, ptr %39, align 8, !tbaa !16
...
18:                                               ; preds = %30
  ...
  %21 = xor i64 %27, 1
  %22 = add i64 %21, %20
  %23 = load ptr, ptr %32, align 8, !tbaa !12
  %24 = icmp eq ptr %23, null
  br i1 %24, label %34, label %25, !llvm.loop !26

25:                                               ; preds = %18, %13
  %26 = phi ptr [ %23, %18 ], [ %14, %13 ]
  %27 = phi i64 [ %22, %18 ], [ 0, %13 ]
  %28 = phi ptr [ %32, %18 ], [ %5, %13 ]
  %29 = icmp eq i64 %27, %1
  br i1 %29, label %36, label %30

30:                                               ; preds = %25
  %31 = getelementptr inbounds %struct.node, ptr %28, i64 0, i32 1
...
36:                                               ; preds = %34, %25, %15, %7
  %37 = phi ptr [ null, %7 ], [ null, %15 ], [ %35, %34 ], [ %26, %25 ]
  ret ptr %37
}
