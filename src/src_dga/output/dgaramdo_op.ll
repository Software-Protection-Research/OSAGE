...
53:                                               ; preds = %29, %43
  %54 = call i64 @strlen(ptr noundef nonnull %2)
  ...
  %56 = getelementptr inbounds %struct.sSelf, ptr %0, i64 0, i32 3
  %57 = call ptr @strcpy(ptr noundef nonnull %56, ptr noundef nonnull %2) #18
  store i64 %7, ptr %5, align 8, !tbaa !15
  %58 = load i8, ptr %2, align 16, !tbaa !16
  store i8 %58, ptr %56, align 8, !tbaa !16
...
65:                                               ; preds = %63, %36
  ...
  %67 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 32, i64 1, ptr %66) #19
  br label %87
...
71:                                               ; preds = %68
  %72 = load ptr, ptr %43, align 8, !tbaa !12
...
74:                                               ; preds = %68
  ...
  %76 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 13, i64 1, ptr %75) #19
  br label %87

77:                                               ; preds = %80
  %78 = load ptr, ptr %83, align 8, !tbaa !12
  %79 = icmp eq ptr %78, null
  br i1 %79, label %85, label %80, !llvm.loop !22

80:                                               ; preds = %77, %71
  %81 = phi ptr [ %83, %77 ], [ %43, %71 ]
  %82 = getelementptr inbounds %struct.node, ptr %81, i64 0, i32 1
  %83 = load ptr, ptr %82, align 8, !tbaa !14
  %84 = icmp eq ptr %83, null
  br i1 %84, label %85, label %77, !llvm.loop !22

85:                                               ; preds = %80, %77
  %86 = load ptr, ptr %81, align 8, !tbaa !12
  br label %87

87:                                               ; preds = %85, %74, %65
  %88 = phi ptr [ null, %65 ], [ null, %74 ], [ %86, %85 ]
  %89 = srem i64 %38, 2
  %90 = icmp eq i64 %89, 0
...
32:                                               ; preds = %29
  %33 = load ptr, ptr %24, align 8, !tbaa !12, !nonnull !25
  br label %41

34:                                               ; preds = %29
  %35 = load ptr, ptr @stderr, align 8, !tbaa !10
  %36 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 13, i64 1, ptr %35) #19
  br label %52

37:                                               ; preds = %46
  %38 = add nuw nsw i64 %43, 1
  %39 = load ptr, ptr %48, align 8, !tbaa !12
  %40 = icmp eq ptr %39, null
  br i1 %40, label %50, label %41, !llvm.loop !26

41:                                               ; preds = %37, %32
  %42 = phi ptr [ %39, %37 ], [ %33, %32 ]
  %43 = phi i64 [ %38, %37 ], [ 0, %32 ]
  %44 = phi ptr [ %48, %37 ], [ %24, %32 ]
  %45 = icmp eq i64 %43, %1
  br i1 %45, label %52, label %46

46:                                               ; preds = %41
  %47 = getelementptr inbounds %struct.node, ptr %44, i64 0, i32 1
  %48 = load ptr, ptr %47, align 8, !tbaa !14
  %49 = icmp eq ptr %48, null
  br i1 %49, label %50, label %37, !llvm.loop !26

50:                                               ; preds = %46, %37
  %51 = load ptr, ptr %44, align 8, !tbaa !12
  br label %52

52:                                               ; preds = %50, %41, %34, %26
  %53 = phi ptr [ null, %26 ], [ null, %34 ], [ %51, %50 ], [ %42, %41 ]
  ret ptr %53
}
...
20:                                               ; preds = %48
  ...
  %22 = load ptr, ptr %50, align 8, !tbaa !12
  %23 = icmp eq ptr %22, null
  br i1 %23, label %52, label %24, !llvm.loop !27

24:                                               ; preds = %20, %14
  %25 = phi i64 [ %21, %20 ], [ 0, %14 ]
  %26 = phi ptr [ %50, %20 ], [ %6, %14 ]
  %27 = icmp eq i64 %25, %1
  %28 = mul i64 %1, %1
  %29 = add i64 %28, %1
  %30 = mul i64 %29, 3
...
48:                                               ; preds = %46
  %49 = getelementptr inbounds %struct.node, ptr %26, i64 0, i32 1
  %50 = load ptr, ptr %49, align 8, !tbaa !14
  %51 = icmp eq ptr %50, null
  br i1 %51, label %52, label %20, !llvm.loop !27
...
54:                                               ; preds = %52, %47, %17, %8
  %55 = phi ptr [ null, %8 ], [ null, %17 ], [ null, %47 ], [ %53, %52 ]
  ret ptr %55
}
