...
27:                                               ; preds = %27, %21
  %28 = phi i32 [ %35, %27 ], [ %25, %21 ]
  %29 = phi i32 [ %34, %27 ], [ 0, %21 ]
  %30 = srem i32 %28, 10
  %31 = mul nsw i32 %29, 10
  %32 = sub i32 %31, -2088665802
  %33 = add i32 %32, %30
  %34 = add i32 %33, -2088665802
  %35 = sdiv i32 %28, 10
  %36 = add i32 %28, 9
...
38:                                               ; preds = %27, %21
  %39 = phi i32 [ 0, %21 ], [ %34, %27 ]
  %40 = icmp eq i32 %39, %7
  br i1 %40, label %41, label %43

41:                                               ; preds = %38
  %42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str)
  br label %47

43:                                               ; preds = %38
  %44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.1, i32 noundef %22)
  %45 = icmp eq i32 %22, 679654
  %46 = select i1 %45, i32 679654, i32 0
  br label %47

47:                                               ; preds = %43, %41
  %48 = phi i32 [ 1, %41 ], [ %46, %43 ]
  %49 = icmp eq i32 %48, 679654
  %50 = select i1 %49, ptr @str.5, ptr @str
  %51 = tail call i32 @puts(ptr nonnull %50)
  %52 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %48)
  ret i32 0
}
