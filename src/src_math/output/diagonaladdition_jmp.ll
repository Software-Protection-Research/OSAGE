...
5:                                                ; preds = %.preheader, %28
  %6 = phi i32 [ %29, %28 ], [ 0, %.preheader ]
  %7 = phi i32 [ %19, %28 ], [ %0, %.preheader ]
  %8 = phi i32 [ %25, %28 ], [ 0, %.preheader ]
  %9 = phi i32 [ %22, %28 ], [ 0, %.preheader ]
  %10 = xor i32 %6, -1
  %11 = add i32 %10, %0
  br label %12
...
define i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #2 {
  ...
  %10 = icmp sgt i32 %7, 0
  br i1 %10, label %.preheader, label %39

.preheader:                                       ; preds = %2
  br label %11

11:                                               ; preds = %.preheader, %34
  %12 = phi i32 [ %35, %34 ], [ 0, %.preheader ]
  %13 = phi i32 [ %25, %34 ], [ %7, %.preheader ]
  %14 = phi i32 [ %31, %34 ], [ 0, %.preheader ]
  %15 = phi i32 [ %28, %34 ], [ 0, %.preheader ]
  %16 = xor i32 %12, -1
  %17 = add i32 %16, %7
  br label %18
