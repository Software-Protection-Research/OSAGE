...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init9447068780143663569, ptr null }]
...
define void @decode2578245238292942276(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init9447068780143663569() {
...
55:                                               ; preds = %0
  call void @decode2578245238292942276(ptr @.str.2, i32 14, ptr @.str.2, ptr %53, ptr %54)
...
94:                                               ; preds = %55
  call void @decode2578245238292942276(ptr @str, i32 11, ptr @str, ptr %92, ptr %93)
...
133:                                              ; preds = %94
  call void @decode2578245238292942276(ptr @str.3, i32 9, ptr @str.3, ptr %131, ptr %132)
  ret void
}
