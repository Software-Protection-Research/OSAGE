...
26:                                               ; preds = %24, %22
  %27 = phi i1 [ %25, %24 ], [ %23, %22 ]
  br i1 %27, label %28, label %32

28:                                               ; preds = %26
  %29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str, i32 noundef %6)
  %30 = icmp eq i32 %6, 1634
  %31 = select i1 %30, i32 1634, i32 1
  br label %34

32:                                               ; preds = %26
  %33 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.1, i32 noundef %6)
  br label %34

34:                                               ; preds = %32, %28
  %35 = phi i32 [ 0, %32 ], [ %31, %28 ]
  %36 = icmp eq i32 %35, 1
  %37 = select i1 %36, ptr @str.5, ptr @str
  %38 = icmp eq i32 %35, 0
  %39 = select i1 %38, ptr @str.5, ptr %37
  %40 = tail call i32 @puts(ptr nonnull %39)
  ret i32 0
}
