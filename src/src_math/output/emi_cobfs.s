...
# %bb.0:
	...
	cvtsd2ss	%xmm1, %xmm0
	cvttss2si	%xmm0, %ebp
	cmpl	$581503168, %ebp                # imm = 0x22A908C0
	leaq	.Lstr.3(%rip), %rax
	leaq	.Lstr(%rip), %rdi
	cmoveq	%rax, %rdi
	callq	puts@PLT
	...
	xorl	%eax, %eax
	callq	printf@PLT
	leal	1188666265(%rbx), %eax
	movl	%ebx, %ecx
	andl	$757219977, %ecx                # imm = 0x2D224289
	movl	%ebx, %edx
	orl	$1492939324, %edx               # imm = 0x58FC723C
	movl	%ebx, %esi
	xorl	$1492939324, %esi               # imm = 0x58FC723C
	movl	%ebx, %edi
	andl	$1492939324, %edi               # imm = 0x58FC723C
	orl	%esi, %edi
	xorl	%eax, %edx
	xorl	%ecx, %eax
	xorl	%edx, %eax
	xorl	%ecx, %edi
	xorl	%eax, %edi
	xorl	$1861182365, %edi               # imm = 0x6EEF639D
	movl	%ebx, %eax
	andl	$531653478, %eax                # imm = 0x1FB06366
	orl	$-531653479, %ebx               # imm = 0xE04F9C99
	addl	$531653479, %ebx                # imm = 0x1FB06367
	xorl	%eax, %ebx
	imull	%edi, %ebx
	movl	%ebx, %eax
	addq	$48, %rsp
