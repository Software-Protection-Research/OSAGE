...
define i32 @add_prime(i32 noundef %0) local_unnamed_addr #0 {
  %2 = icmp slt i32 %0, 1
  br i1 %2, label %24, label %.preheader

.preheader:                                       ; preds = %1
  br label %3

3:                                                ; preds = %.preheader, %20
  %4 = phi i32 [ %21, %20 ], [ 0, %.preheader ]
  %5 = phi i32 [ %22, %20 ], [ 1, %.preheader ]
  br label %6
...
20:                                               ; preds = %17, %15
  ...
  %22 = add nuw i32 %5, 1
  %23 = icmp eq i32 %5, %0
  br i1 %23, label %.loopexit, label %3, !llvm.loop !7

.loopexit:                                        ; preds = %20
  br label %24

24:                                               ; preds = %.loopexit, %1
  %25 = phi i32 [ 0, %1 ], [ %21, %.loopexit ]
  ret i32 %25
}
...
9:                                                ; preds = %.preheader, %26
  %10 = phi i32 [ %27, %26 ], [ 0, %.preheader ]
  %11 = phi i32 [ %28, %26 ], [ 1, %.preheader ]
  br label %12
...
26:                                               ; preds = %23, %21
  ...
  %28 = add nuw i32 %11, 1
  %29 = icmp eq i32 %11, %7
  br i1 %29, label %.loopexit, label %9, !llvm.loop !7

.loopexit:                                        ; preds = %26
  br label %30

30:                                               ; preds = %.loopexit, %2
  %31 = phi i32 [ 0, %2 ], [ %27, %.loopexit ]
