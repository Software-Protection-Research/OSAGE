...
8:                                                ; preds = %2
  %9 = icmp sgt i32 %0, 1
  br i1 %9, label %10, label %codeRepl
...
14:                                               ; preds = %14, %10
  ...
  br i1 %22, label %codeRepl, label %14, !llvm.loop !14

codeRepl:                                         ; preds = %8, %14
  call void @main.extracted(i32 %0, ptr %6)
  br label %.ret
...
define internal void @main.extracted(i32 %0, ptr %1) #7 {
newFuncRoot:
  br label %2
...
codeRepl:                                         ; preds = %2
  call void @main.extracted.extracted(i32 %0, ptr %1)
...
; Function Attrs: noinline nounwind uwtable
define internal void @main.extracted.extracted(i32 %0, ptr %1) #7 {
newFuncRoot:
  br label %2

2:                                                ; preds = %newFuncRoot
  %3 = add nsw i32 %0, -1
  %4 = tail call i32 @square_array(ptr noundef nonnull %1, i32 noundef %3)
  %5 = icmp eq i32 %4, -284893460
  %6 = select i1 %5, ptr @str.6, ptr @str.5
  %7 = tail call i32 @puts(ptr nonnull %6)
  %8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %4)
  br label %.ret.exitStub.exitStub

.ret.exitStub.exitStub:                           ; preds = %2
  ret void
}
