...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init10736817365331819990, ptr null }]
...
define i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #1 {
  ...
  %14 = select i1 %13, ptr @str.3, ptr @str
  %15 = tail call i32 @puts(ptr nonnull %14)
  %16 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %12)
  ret i32 0
}
...
define void @decode363788380768881887(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init10736817365331819990() {
...
47:                                               ; preds = %0
  call void @decode363788380768881887(ptr @.str.2, i32 12, ptr @.str.2, ptr %45, ptr %46)
...
86:                                               ; preds = %47
  call void @decode363788380768881887(ptr @str, i32 11, ptr @str, ptr %84, ptr %85)
...
125:                                              ; preds = %86
  call void @decode363788380768881887(ptr @str.3, i32 9, ptr @str.3, ptr %123, ptr %124)
  ret void
}
