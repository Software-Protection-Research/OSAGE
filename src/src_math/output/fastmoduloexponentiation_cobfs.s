...
# %bb.0:
	...
	movq	%rax, %r14
	movl	%ebx, %eax
	orl	$953747708, %eax                # imm = 0x38D908FC
	movl	%ebx, %ecx
	xorl	$953747708, %ecx                # imm = 0x38D908FC
	andl	$953747708, %ebx                # imm = 0x38D908FC
	orl	%ecx, %ebx
	xorl	%eax, %ebx
	xorl	$-149032579, %ebx               # imm = 0xF71DF17D
	imull	$-1809042432, %ebx, %eax        # imm = 0x942C3400
	cmpl	%eax, %r14d
	leaq	.Lstr.3(%rip), %rax
	leaq	.Lstr(%rip), %rdi
	cmoveq	%rax, %rdi
