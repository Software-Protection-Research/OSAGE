...
24:                                               ; preds = %19
  %25 = select i1 %21, ptr @str.3, ptr @str
  %26 = tail call i32 @puts(ptr nonnull %25)
  %27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %20)
  br label %32

28:                                               ; preds = %19
  %29 = select i1 %21, ptr @str.3, ptr @str
  %30 = tail call i32 @puts(ptr nonnull %29)
  %31 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %20)
  br label %32

32:                                               ; preds = %28, %24
  %33 = phi ptr [ %29, %28 ], [ %25, %24 ]
  %34 = phi i32 [ %30, %28 ], [ %26, %24 ]
  %35 = phi i32 [ %31, %28 ], [ %27, %24 ]
  ret i32 0
}
