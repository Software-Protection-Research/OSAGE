...
entry:
  ...
  store ptr blockaddress(@BKDRHash, %BogusBasciBlock), ptr %2, align 8
...
BogusBasciBlock:                                  ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@BKDRHash, %"3"), ptr %7, align 8
  %8 = getelementptr ptr, ptr %JumpTable, i32 2
  store ptr blockaddress(@BKDRHash, %EntryBasicBlockSplit), ptr %8, align 8
...
EntryBasicBlockSplit:                             ; preds = %BogusBasicBlock, %loopStart
  ...
  %23 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 3
...
28:                                               ; preds = %loopStart
  ...
  %36 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 6
  %37 = load i32, ptr %36, align 4
  %38 = sub i32 %35, %37
  %39 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 11
  %40 = load i32, ptr %39, align 4
  %41 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 7
...
48:                                               ; preds = %loopStart
  ...
  %61 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 1
  %62 = load i32, ptr %61, align 4
  %63 = sub i32 %60, %62
  %64 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 8
  %65 = load i32, ptr %64, align 4
  %66 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 11
...
70:                                               ; preds = %loopStart
  ...
  %71 = mul i32 %.reload13, 131
  %72 = load i8, ptr %.reload15, align 1, !tbaa !4
  %73 = sext i8 %72 to i32
  %74 = add i32 %71, %73
  %75 = getelementptr inbounds i8, ptr %.reload15, i64 1
  %76 = add nuw i32 %.reload11, 1
  %.reload8 = load i32, ptr %.reg2mem7, align 4
  %77 = icmp eq i32 %76, %.reload8
  %78 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 7
  %79 = load i32, ptr %78, align 4
  %80 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 5
  %81 = load i32, ptr %80, align 4
  %82 = add i32 %79, %81
  %83 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 6
  ...
  store i32 %74, ptr %.reg2mem12, align 4
  store ptr %75, ptr %.reg2mem14, align 8
  store i32 %74, ptr %.reg2mem16, align 4
  br label %loopEnd

89:                                               ; preds = %loopStart
  %.reload17 = load i32, ptr %.reg2mem16, align 4
  %90 = icmp eq i32 %.reload17, 31298380
  %91 = select i1 %90, ptr @str.6, ptr @str
  %92 = call i32 @puts(ptr nonnull %91)
  %93 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %.reload17)
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %14) #10
  ret i32 0

BogusBasicBlock:                                  ; preds = %loopStart
  %94 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 0
  store i32 -1, ptr %94, align 4
  %95 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 2
  store i32 1, ptr %95, align 4
  %96 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 4
  store i32 3, ptr %96, align 4
  %97 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 6
  store i32 5, ptr %97, align 4
  %98 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 8
  store i32 7, ptr %98, align 4
  %99 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 10
  store i32 9, ptr %99, align 4
  %100 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 0
