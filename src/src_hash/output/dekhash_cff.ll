...
EntryBasicBlockSplit:                             ; preds = %BogusBasicBlock, %loopStart
  ...
  store i32 %1, ptr %.reg2mem2, align 4
...
22:                                               ; preds = %loopStart
  ...
  %23 = tail call i32 @llvm.fshl.i32(i32 %.reload3, i32 %.reload3, i32 5)
...
entry:
  ...
  %8 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.reload13) #7
...
BogusBasciBlock:                                  ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@main, %EntryBasicBlockSplit), ptr %11, align 8
  %12 = getelementptr ptr, ptr %JumpTable, i32 2
  store ptr blockaddress(@main, %"3"), ptr %12, align 8
...
EntryBasicBlockSplit:                             ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store i32 %.reload17, ptr %.reg2mem21, align 4
  store ptr %.reload12, ptr %.reg2mem23, align 8
...
"2":                                              ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %17 = tail call i32 @llvm.fshl.i32(i32 %.reload22, i32 %.reload22, i32 5)
  %18 = load i8, ptr %.reload24, align 1, !tbaa !4
  %19 = sext i8 %18 to i32
  %20 = xor i32 %17, %19
  %21 = getelementptr inbounds i8, ptr %.reload24, i64 1
  %22 = add nuw i32 %.reload20, 1
  %.reload16 = load i32, ptr %.reg2mem14, align 4
  %23 = icmp eq i32 %22, %.reload16
  %.reload4 = load ptr, ptr %.reg2mem3, align 8
  %.reload8 = load ptr, ptr %.reg2mem7, align 8
  %24 = select i1 %23, ptr %.reload8, ptr %.reload4
  %25 = load ptr, ptr %24, align 8
  store i32 %22, ptr %.reg2mem19, align 4
...
"3":                                              ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %26 = icmp eq i32 %.reload26, 8100372
  %27 = select i1 %26, ptr @str.3, ptr @str
  %28 = tail call i32 @puts(ptr nonnull %27)
  %29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %.reload26)
  ret i32 0
}
