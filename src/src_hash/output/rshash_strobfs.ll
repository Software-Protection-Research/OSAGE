...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init11587310774052631675, ptr null }]
...
8:                                                ; preds = %8, %2
  %9 = phi i32 [ %19, %8 ], [ 0, %2 ]
  %10 = phi i32 [ %16, %8 ], [ 0, %2 ]
  %11 = phi i32 [ %17, %8 ], [ 63689, %2 ]
  %12 = phi ptr [ %18, %8 ], [ %4, %2 ]
  %13 = mul i32 %11, %10
  %14 = load i8, ptr %12, align 1, !tbaa !4
  %15 = sext i8 %14 to i32
  %16 = add i32 %13, %15
  %17 = mul i32 %11, 378551
...
21:                                               ; preds = %8, %2
  %22 = phi i32 [ 0, %2 ], [ %16, %8 ]
  %23 = icmp eq i32 %22, 280461880
  %24 = select i1 %23, ptr @str.3, ptr @str
  %25 = tail call i32 @puts(ptr nonnull %24)
  %26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %22)
  ret i32 0
}
...
define void @decode2410592281697752815(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init11587310774052631675() {
...
47:                                               ; preds = %0
  call void @decode2410592281697752815(ptr @.str.2, i32 12, ptr @.str.2, ptr %45, ptr %46)
...
86:                                               ; preds = %47
  call void @decode2410592281697752815(ptr @str, i32 11, ptr @str, ptr %84, ptr %85)
...
125:                                              ; preds = %86
  call void @decode2410592281697752815(ptr @str.3, i32 9, ptr @str.3, ptr %123, ptr %124)
  ret void
}
