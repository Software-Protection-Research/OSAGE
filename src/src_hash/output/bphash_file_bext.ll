...
codeRepl1:                                        ; preds = %6
  ...
  br i1 %targetBlock, label %23, label %12

12:                                               ; preds = %codeRepl1, %12
  %13 = phi i32 [ %21, %12 ], [ 0, %codeRepl1 ]
  %14 = phi i32 [ %19, %12 ], [ 0, %codeRepl1 ]
  %15 = phi ptr [ %20, %12 ], [ %.reload, %codeRepl1 ]
  %16 = shl i32 %14, 7
  ...
  %21 = add nuw i32 %13, 1
  %22 = icmp eq i32 %21, %.reload3
  br i1 %22, label %23, label %12, !llvm.loop !7

23:                                               ; preds = %codeRepl1, %12
  %24 = phi i32 [ 0, %codeRepl1 ], [ %19, %12 ]
  %25 = icmp eq i32 %24, 1287453194
  %26 = select i1 %25, ptr @str.6, ptr @str
  %27 = call i32 @puts(ptr nonnull %26)
  %28 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %24)
...
0:                                                ; preds = %newFuncRoot
  ...
  %2 = call i64 @fwrite(ptr nonnull @.str.2, i64 20, i64 1, ptr %1) #14
  call void @exit(i32 noundef 1) #13
  unreachable
}

; Function Attrs: noinline nounwind uwtable
define internal i1 @main.extracted.1(ptr %0, ptr %.out, ptr %.out1) #11 {
newFuncRoot:
  br label %1
...
codeRepl:                                         ; preds = %1
  %targetBlock = call i1 @main.extracted.1.extracted(ptr %0, i64 %3, ptr %.out, ptr %.out1)
...
; Function Attrs: noinline nounwind uwtable
define internal i1 @main.extracted.1.extracted(ptr %0, i64 %1, ptr %.out, ptr %.out1) #11 {
newFuncRoot:
  br label %2

2:                                                ; preds = %newFuncRoot
  %3 = call i32 @fseek(ptr noundef nonnull %0, i64 noundef 0, i32 noundef 0)
  %4 = add nsw i64 %1, 1
  %5 = call noalias ptr @malloc(i64 noundef %4) #15
  store ptr %5, ptr %.out, align 8
  %6 = call i64 @fread(ptr noundef %5, i64 noundef 1, i64 noundef %1, ptr noundef nonnull %0)
  %7 = call i32 @fclose(ptr noundef nonnull %0)
  %8 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %5) #16
