...
codeRepl:                                         ; preds = %2
  ...
  call void @DJBHash.extracted(ptr %0, i32 %1, ptr %.loc)
  %.reload = load i32, ptr %.loc, align 4
  call void @llvm.lifetime.end.p0(i64 -1, ptr %.loc)
  br label %4

4:                                                ; preds = %codeRepl, %2
  %5 = phi i32 [ 5381, %2 ], [ %.reload, %codeRepl ]
  ret i32 %5
}
...
26:                                               ; preds = %26, %15
  ...
  %30 = mul i32 %28, 33
  %31 = load i8, ptr %29, align 1, !tbaa !8
...
define internal void @DJBHash.extracted(ptr %0, i32 %1, ptr %.out) #10 {
newFuncRoot:
...
2:                                                ; preds = %codeRepl, %newFuncRoot
  ...
  %4 = phi i32 [ %.reload, %codeRepl ], [ 5381, %newFuncRoot ]
...
codeRepl:                                         ; preds = %2
  ...
  %targetBlock = call i1 @DJBHash.extracted.extracted(i32 %4, ptr %5, ptr %.out, i32 %3, i32 %1, ptr %.loc, ptr %.loc1, ptr %.loc2)
  %.reload = load i32, ptr %.loc, align 4
...
; Function Attrs: nofree noinline norecurse nounwind uwtable
define internal i1 @DJBHash.extracted.extracted(i32 %0, ptr %1, ptr %.out, i32 %2, i32 %3, ptr %.out1, ptr %.out2, ptr %.out3) #10 {
newFuncRoot:
  br label %4
