...
26:                                               ; preds = %26, %15
  ...
  %54 = or i1 %53, %51
  %55 = sub i1 %54, %52
  br i1 %55, label %56, label %26, !llvm.loop !7

56:                                               ; preds = %26, %15
  %57 = phi i32 [ 0, %15 ], [ %38, %26 ]
  %58 = icmp eq i32 %57, 8047178
  %59 = select i1 %58, ptr @str.6, ptr @str
  %60 = call i32 @puts(ptr nonnull %59)
  %61 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %57)
