...
26:                                               ; preds = %26, %15
  %27 = phi i32 [ %39, %26 ], [ 0, %15 ]
  %28 = phi i32 [ %36, %26 ], [ 0, %15 ]
  %29 = phi i32 [ %37, %26 ], [ 63689, %15 ]
  %30 = phi ptr [ %38, %26 ], [ %20, %15 ]
  %31 = mul i32 %29, %28
...
41:                                               ; preds = %26, %15
  %42 = phi i32 [ 0, %15 ], [ %36, %26 ]
  %43 = icmp eq i32 %42, 52529410
  %44 = select i1 %43, ptr @str.6, ptr @str
  %45 = call i32 @puts(ptr nonnull %44)
  %46 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %42)
