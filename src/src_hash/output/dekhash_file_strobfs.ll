...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init15544665534453449947, ptr null }]
...
26:                                               ; preds = %26, %15
  %27 = phi i32 [ %35, %26 ], [ 0, %15 ]
  %28 = phi i32 [ %33, %26 ], [ %24, %15 ]
  %29 = phi ptr [ %34, %26 ], [ %20, %15 ]
  %30 = call i32 @llvm.fshl.i32(i32 %28, i32 %28, i32 5)
...
37:                                               ; preds = %26, %15
  %38 = phi i32 [ %24, %15 ], [ %33, %26 ]
  %39 = icmp eq i32 %38, 225657482
...
define void @decode11883145740314831191(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init15544665534453449947() {
...
15:                                               ; preds = %0
  call void @decode11883145740314831191(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode11883145740314831191(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
...
133:                                              ; preds = %86
  call void @decode11883145740314831191(ptr @.str.5, i32 12, ptr @.str.5, ptr %131, ptr %132)
...
172:                                              ; preds = %133
  call void @decode11883145740314831191(ptr @str, i32 11, ptr @str, ptr %170, ptr %171)
  %outArray7 = alloca [18 x i8], align 1
  %173 = getelementptr inbounds [18 x i8], ptr %outArray7, i32 0, i32 0
  store i8 33, ptr %173, align 1
...
211:                                              ; preds = %172
  call void @decode11883145740314831191(ptr @str.6, i32 9, ptr @str.6, ptr %209, ptr %210)
  ret void
}
