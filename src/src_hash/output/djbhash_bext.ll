...
14:                                               ; preds = %codeRepl, %3
  %15 = phi i32 [ 5381, %codeRepl ], [ %10, %3 ]
  %16 = icmp eq i32 %15, 2090756197
...
codeRepl:                                         ; preds = %.split
  %targetBlock = call i1 @main..split.extracted(i64 %3, ptr %.out1)
...
; Function Attrs: nofree noinline nounwind uwtable
define internal i1 @main..split.extracted(i64 %0, ptr %.out1) #6 {
newFuncRoot:
  br label %1
