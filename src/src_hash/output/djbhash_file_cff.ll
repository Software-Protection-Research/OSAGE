...
EntryBasicBlockSplit:                             ; preds = %BogusBasicBlock, %loopStart
  ...
  store i32 5381, ptr %.reg2mem2, align 4
  store ptr %0, ptr %.reg2mem4, align 8
  store i32 5381, ptr %.reg2mem6, align 4
  br label %loopEnd
...
BogusBasciBlock:                                  ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@main, %"6"), ptr %13, align 8
  %14 = getelementptr ptr, ptr %JumpTable, i32 4
  store ptr blockaddress(@main, %BogusBasciBlock), ptr %14, align 8
  %15 = getelementptr ptr, ptr %JumpTable, i32 6
  store ptr blockaddress(@main, %"7"), ptr %15, align 8
...
"5":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store i32 5381, ptr %.reg2mem35, align 4
  store ptr %33, ptr %.reg2mem37, align 8
  store i32 5381, ptr %.reg2mem39, align 4
...
"6":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %41 = mul i32 %.reload36, 33
  %42 = load i8, ptr %.reload38, align 1, !tbaa !4
  %43 = sext i8 %42 to i32
  %44 = add i32 %41, %43
  %45 = getelementptr inbounds i8, ptr %.reload38, i64 1
  %46 = add nuw i32 %.reload34, 1
  %.reload31 = load i32, ptr %.reg2mem30, align 4
  %47 = icmp eq i32 %46, %.reload31
  ...
  store i32 %46, ptr %.reg2mem33, align 4
  store i32 %44, ptr %.reg2mem35, align 4
  store ptr %45, ptr %.reg2mem37, align 8
  store i32 %44, ptr %.reg2mem39, align 4
...
"7":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %50 = icmp eq i32 %.reload40, 275477775
  %51 = select i1 %50, ptr @str.6, ptr @str
  %52 = call i32 @puts(ptr nonnull %51)
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %.reload40)
