...
entry:
  ...
  store ptr blockaddress(@DJBHash, %BogusBasciBlock), ptr %2, align 8
...
BogusBasciBlock:                                  ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@DJBHash, %"3"), ptr %7, align 8
  %8 = getelementptr ptr, ptr %JumpTable, i32 2
  store ptr blockaddress(@DJBHash, %EntryBasicBlockSplit), ptr %8, align 8
...
EntryBasicBlockSplit:                             ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store i32 5381, ptr %.reg2mem13, align 4
  store ptr %0, ptr %.reg2mem15, align 8
  store i32 5381, ptr %.reg2mem17, align 4
...
EntryBasicBlockSplit:                             ; preds = %BogusBasicBlock, %loopStart
  ...
  %22 = getelementptr inbounds [8 x i32], ptr %lookupTable, i32 0, i32 7
  ...
  store i32 5381, ptr %.reg2mem8, align 4
  store ptr %.reload, ptr %.reg2mem10, align 8
  store i32 5381, ptr %.reg2mem12, align 4
  br label %loopEnd
...
26:                                               ; preds = %loopStart
  ...
  %41 = getelementptr inbounds [8 x i32], ptr %lookupTable, i32 0, i32 7
...
45:                                               ; preds = %loopStart
  ...
  %46 = icmp eq i32 %.reload13, 2090756197
