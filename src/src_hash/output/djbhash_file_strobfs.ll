...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init7568509682808646027, ptr null }]
...
37:                                               ; preds = %26, %15
  %38 = phi i32 [ 5381, %15 ], [ %33, %26 ]
  %39 = icmp eq i32 %38, 275477775
...
define void @decode6337676015863646424(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init7568509682808646027() {
...
15:                                               ; preds = %0
  call void @decode6337676015863646424(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode6337676015863646424(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
...
133:                                              ; preds = %86
  call void @decode6337676015863646424(ptr @.str.5, i32 12, ptr @.str.5, ptr %131, ptr %132)
...
172:                                              ; preds = %133
  call void @decode6337676015863646424(ptr @str, i32 11, ptr @str, ptr %170, ptr %171)
...
211:                                              ; preds = %172
  call void @decode6337676015863646424(ptr @str.6, i32 9, ptr @str.6, ptr %209, ptr %210)
  ret void
}
