...
BogusBasciBlock:                                  ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@SDBMHash, %"2"), ptr %7, align 8
  %8 = getelementptr ptr, ptr %JumpTable, i32 2
  store ptr blockaddress(@SDBMHash, %"3"), ptr %8, align 8
...
70:                                               ; preds = %loopStart
  ...
  %71 = load i8, ptr %.reload15, align 1, !tbaa !4
  %72 = sext i8 %71 to i32
  %73 = mul i32 %.reload13, 65599
  %74 = add i32 %73, %72
  ...
  %78 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 6
  %79 = load i32, ptr %78, align 4
  %80 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 0
  %81 = load i32, ptr %80, align 4
  %82 = sub i32 %79, %81
  %83 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 8
  %84 = load i32, ptr %83, align 4
  %85 = getelementptr inbounds [12 x i32], ptr %lookupTable, i32 0, i32 11
...
89:                                               ; preds = %loopStart
  ...
  %90 = icmp eq i32 %.reload17, 1533049688
