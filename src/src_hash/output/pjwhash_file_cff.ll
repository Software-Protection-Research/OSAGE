...
BogusBasciBlock:                                  ; preds = %entry, %"2", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@PJWHash, %BogusBasciBlock), ptr %7, align 8
  %8 = getelementptr ptr, ptr %JumpTable, i32 2
  store ptr blockaddress(@PJWHash, %"2"), ptr %8, align 8
...
BogusBasciBlock:                                  ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  store ptr blockaddress(@main, %"5"), ptr %13, align 8
  ...
  store ptr blockaddress(@main, %"3"), ptr %15, align 8
  %.reload1 = load ptr, ptr %.reg2mem, align 8
...
"6":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %41 = shl i32 %.reload36, 4
  %42 = load i8, ptr %.reload38, align 1, !tbaa !4
  ...
  %51 = getelementptr inbounds i8, ptr %.reload38, i64 1
  %52 = add nuw i32 %.reload34, 1
  %.reload31 = load i32, ptr %.reg2mem30, align 4
  %53 = icmp eq i32 %52, %.reload31
  %.reload16 = load ptr, ptr %.reg2mem15, align 8
  %.reload20 = load ptr, ptr %.reg2mem19, align 8
  %54 = select i1 %53, ptr %.reload20, ptr %.reload16
  %55 = load ptr, ptr %54, align 8
  store i32 %52, ptr %.reg2mem33, align 4
  store i32 %50, ptr %.reg2mem35, align 4
  store ptr %51, ptr %.reg2mem37, align 8
  store i32 %50, ptr %.reg2mem39, align 4
  indirectbr ptr %55, [label %BogusBasciBlock, label %EntryBasicBlockSplit, label %"2", label %"3", label %"4", label %"5", label %"6", label %"7"]

"7":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  %.reload40 = load i32, ptr %.reg2mem39, align 4
  %56 = icmp eq i32 %.reload40, 8047178
  %57 = select i1 %56, ptr @str.6, ptr @str
  %58 = call i32 @puts(ptr nonnull %57)
  %59 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %.reload40)
