...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init13983828542759830021, ptr null }]
...
37:                                               ; preds = %26, %15
  %38 = phi i32 [ 0, %15 ], [ %33, %26 ]
  %39 = icmp eq i32 %38, 1533049688
...
define void @decode12937256786492978881(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init13983828542759830021() {
...
15:                                               ; preds = %0
  call void @decode12937256786492978881(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode12937256786492978881(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
  %outArray3 = alloca [22 x i8], align 1
  %87 = getelementptr inbounds [22 x i8], ptr %outArray3, i32 0, i32 0
  store i8 72, ptr %87, align 1
...
133:                                              ; preds = %86
  call void @decode12937256786492978881(ptr @.str.5, i32 12, ptr @.str.5, ptr %131, ptr %132)
...
172:                                              ; preds = %133
  call void @decode12937256786492978881(ptr @str, i32 11, ptr @str, ptr %170, ptr %171)
...
211:                                              ; preds = %172
  call void @decode12937256786492978881(ptr @str.6, i32 9, ptr @str.6, ptr %209, ptr %210)
  ret void
}
