...
codeRepl:                                         ; preds = %2
  ...
  %targetBlock = call i1 @main.extracted.extracted(ptr %5, i32 %6, ptr %.out, i32 %3, i32 %1, ptr %.loc, ptr %.loc1, ptr %.loc2)
  %.reload = load i32, ptr %.loc, align 4
...
; Function Attrs: nofree noinline nounwind uwtable
define internal i1 @main.extracted.extracted(ptr %0, i32 %1, ptr %.out, i32 %2, i32 %3, ptr %.out1, ptr %.out2, ptr %.out3) #6 {
newFuncRoot:
  br label %4
