...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init17781828565038066845, ptr null }]
...
define void @decode13129304847972408171(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init17781828565038066845() {
...
47:                                               ; preds = %0
  call void @decode13129304847972408171(ptr @.str.2, i32 12, ptr @.str.2, ptr %45, ptr %46)
...
86:                                               ; preds = %47
  call void @decode13129304847972408171(ptr @str, i32 11, ptr @str, ptr %84, ptr %85)
...
125:                                              ; preds = %86
  call void @decode13129304847972408171(ptr @str.3, i32 9, ptr @str.3, ptr %123, ptr %124)
  ret void
}
