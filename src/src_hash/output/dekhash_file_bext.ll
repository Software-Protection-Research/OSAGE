...
codeRepl:                                         ; preds = %2
  ...
  call void @DEKHash.extracted(i32 %1, ptr %0, ptr %.loc)
  %.reload = load i32, ptr %.loc, align 4
  call void @llvm.lifetime.end.p0(i64 -1, ptr %.loc)
  br label %4

4:                                                ; preds = %codeRepl, %2
  %5 = phi i32 [ %1, %2 ], [ %.reload, %codeRepl ]
  ret i32 %5
}
...
17:                                               ; preds = %17, %6
  ...
  %19 = phi i32 [ %24, %17 ], [ %15, %6 ]
  %20 = phi ptr [ %25, %17 ], [ %11, %6 ]
  %21 = call i32 @llvm.fshl.i32(i32 %19, i32 %19, i32 5)
...
28:                                               ; preds = %17, %6
  %29 = phi i32 [ %15, %6 ], [ %24, %17 ]
  %30 = icmp eq i32 %29, 225657482
...
define internal void @DEKHash.extracted(i32 %0, ptr %1, ptr %.out) #11 {
newFuncRoot:
...
2:                                                ; preds = %codeRepl, %newFuncRoot
  ...
  %5 = phi ptr [ %.reload3, %codeRepl ], [ %1, %newFuncRoot ]
  %6 = tail call i32 @llvm.fshl.i32(i32 %4, i32 %4, i32 5)
...
codeRepl:                                         ; preds = %2
  ...
  %targetBlock = call i1 @DEKHash.extracted.extracted(i8 %7, i32 %6, ptr %.out, ptr %5, i32 %3, i32 %0, ptr %.loc, ptr %.loc1, ptr %.loc2)
  %.reload = load i32, ptr %.loc, align 4
...
; Function Attrs: nofree noinline nounwind uwtable
define internal i1 @DEKHash.extracted.extracted(i8 %0, i32 %1, ptr %.out, ptr %2, i32 %3, i32 %4, ptr %.out1, ptr %.out2, ptr %.out3) #11 {
newFuncRoot:
  br label %5
...
5:                                                ; preds = %newFuncRoot
  ...
  %10 = icmp eq i32 %9, %4
  br i1 %10, label %.exitStub.exitStub, label %.exitStub, !llvm.loop !7
...
codeRepl:                                         ; preds = %2
  %targetBlock = call i1 @main.extracted.extracted(i1 %7)
...
0:                                                ; preds = %newFuncRoot
  ...
  %2 = call i64 @fwrite(ptr nonnull @.str.2, i64 20, i64 1, ptr %1) #18
  call void @exit(i32 noundef 1) #15
  unreachable
}

; Function Attrs: noinline nounwind uwtable
define internal i1 @main.extracted.extracted(i1 %0) #12 {
newFuncRoot:
  br label %1
