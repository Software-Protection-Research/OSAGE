...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init6429385102799770306, ptr null }]
...
26:                                               ; preds = %26, %15
  %27 = phi i32 [ %40, %26 ], [ 0, %15 ]
  %28 = phi i32 [ %38, %26 ], [ 0, %15 ]
  %29 = phi ptr [ %39, %26 ], [ %20, %15 ]
  %30 = shl i32 %28, 4
  %31 = load i8, ptr %29, align 1, !tbaa !4
  %32 = sext i8 %31 to i32
  %33 = add i32 %30, %32
  %34 = and i32 %33, -268435456
  %35 = lshr exact i32 %34, 24
  %36 = xor i32 %35, %33
  %37 = xor i32 %34, -1
  %38 = and i32 %36, %37
  ...
  br i1 %41, label %42, label %26, !llvm.loop !7

42:                                               ; preds = %26, %15
  %43 = phi i32 [ 0, %15 ], [ %38, %26 ]
  %44 = icmp eq i32 %43, 8047178
...
define void @decode14838242756348171279(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init6429385102799770306() {
...
15:                                               ; preds = %0
  call void @decode14838242756348171279(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode14838242756348171279(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
...
133:                                              ; preds = %86
  call void @decode14838242756348171279(ptr @.str.5, i32 12, ptr @.str.5, ptr %131, ptr %132)
...
172:                                              ; preds = %133
  call void @decode14838242756348171279(ptr @str, i32 11, ptr @str, ptr %170, ptr %171)
...
211:                                              ; preds = %172
  call void @decode14838242756348171279(ptr @str.6, i32 9, ptr @str.6, ptr %209, ptr %210)
  ret void
}
