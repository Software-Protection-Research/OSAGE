...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init752087924443747453, ptr null }]
...
26:                                               ; preds = %26, %15
  %27 = phi i32 [ %38, %26 ], [ 0, %15 ]
  %28 = phi i32 [ %36, %26 ], [ 1315423911, %15 ]
  %29 = phi ptr [ %37, %26 ], [ %20, %15 ]
  %30 = shl i32 %28, 5
  ...
  br i1 %39, label %40, label %26, !llvm.loop !7

40:                                               ; preds = %26, %15
  %41 = phi i32 [ 1315423911, %15 ], [ %36, %26 ]
  %42 = icmp eq i32 %41, 1614559639
  %43 = select i1 %42, ptr @str.6, ptr @str
  %44 = call i32 @puts(ptr nonnull %43)
  %45 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %41)
...
define void @decode16227951022743964880(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init752087924443747453() {
...
15:                                               ; preds = %0
  call void @decode16227951022743964880(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode16227951022743964880(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
...
133:                                              ; preds = %86
  call void @decode16227951022743964880(ptr @.str.5, i32 12, ptr @.str.5, ptr %131, ptr %132)
...
172:                                              ; preds = %133
  call void @decode16227951022743964880(ptr @str, i32 11, ptr @str, ptr %170, ptr %171)
...
211:                                              ; preds = %172
  call void @decode16227951022743964880(ptr @str.6, i32 9, ptr @str.6, ptr %209, ptr %210)
  ret void
}
