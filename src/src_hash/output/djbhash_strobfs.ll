...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init15930351327773715249, ptr null }]
...
19:                                               ; preds = %8, %2
  %20 = phi i32 [ 5381, %2 ], [ %15, %8 ]
  %21 = icmp eq i32 %20, 2090756197
...
define void @decode4167509317527584020(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init15930351327773715249() {
...
47:                                               ; preds = %0
  call void @decode4167509317527584020(ptr @.str.2, i32 12, ptr @.str.2, ptr %45, ptr %46)
...
86:                                               ; preds = %47
  call void @decode4167509317527584020(ptr @str, i32 11, ptr @str, ptr %84, ptr %85)
...
125:                                              ; preds = %86
  call void @decode4167509317527584020(ptr @str.3, i32 9, ptr @str.3, ptr %123, ptr %124)
  ret void
}
