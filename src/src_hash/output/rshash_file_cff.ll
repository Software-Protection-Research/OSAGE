...
EntryBasicBlockSplit:                             ; preds = %BogusBasicBlock, %loopStart
  %10 = icmp eq i32 %1, 0
  %11 = getelementptr inbounds [8 x i32], ptr %lookupTable, i32 0, i32 7
  %12 = load i32, ptr %11, align 4
  %13 = getelementptr inbounds [8 x i32], ptr %lookupTable, i32 0, i32 5
...
22:                                               ; preds = %loopStart
  ...
  %35 = srem i32 %32, %34
  %36 = getelementptr inbounds [8 x i32], ptr %lookupTable, i32 0, i32 1
...
"3":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %22 = call ptr @strncpy(ptr noundef nonnull %10, ptr noundef nonnull dereferenceable(1) %21, i64 noundef 512) #10
...
"4":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %28 = call i64 @fwrite(ptr nonnull @.str.2, i64 20, i64 1, ptr %27) #12
...
"5":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %36 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %33) #14
  %37 = trunc i64 %36 to i32
  store i32 %37, ptr %.reg2mem30, align 4
  %.reload32 = load i32, ptr %.reg2mem30, align 4
  %38 = icmp eq i32 %.reload32, 0
  ...
  store i32 63689, ptr %.reg2mem37, align 4
...
"6":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  ...
  %41 = mul i32 %.reload38, %.reload36
  %42 = load i8, ptr %.reload40, align 1, !tbaa !4
  %43 = sext i8 %42 to i32
  %44 = add i32 %41, %43
  %45 = mul i32 %.reload38, 378551
  %46 = getelementptr inbounds i8, ptr %.reload40, i64 1
  %47 = add nuw i32 %.reload34, 1
  %.reload31 = load i32, ptr %.reg2mem30, align 4
  %48 = icmp eq i32 %47, %.reload31
  %.reload16 = load ptr, ptr %.reg2mem15, align 8
  %.reload20 = load ptr, ptr %.reg2mem19, align 8
  %49 = select i1 %48, ptr %.reload20, ptr %.reload16
  %50 = load ptr, ptr %49, align 8
  store i32 %47, ptr %.reg2mem33, align 4
  store i32 %44, ptr %.reg2mem35, align 4
  store i32 %45, ptr %.reg2mem37, align 4
  store ptr %46, ptr %.reg2mem39, align 8
  store i32 %44, ptr %.reg2mem41, align 4
  indirectbr ptr %50, [label %BogusBasciBlock, label %EntryBasicBlockSplit, label %"2", label %"3", label %"4", label %"5", label %"6", label %"7"]

"7":                                              ; preds = %entry, %"6", %"5", %"3", %EntryBasicBlockSplit, %BogusBasciBlock
  %.reload42 = load i32, ptr %.reg2mem41, align 4
  %51 = icmp eq i32 %.reload42, 52529410
  %52 = select i1 %51, ptr @str.6, ptr @str
  %53 = call i32 @puts(ptr nonnull %52)
  %54 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.5, i32 noundef %.reload42)
