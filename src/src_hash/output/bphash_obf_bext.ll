...
9:                                                ; preds = %9, %3
  %10 = phi i32 [ 0, %3 ], [ %29, %9 ]
  %11 = tail call ptr @malloc(i32 noundef 24) #9
  ...
  %30 = icmp eq i32 %10, 0
  br i1 %30, label %9, label %codeRepl, !llvm.loop !16

codeRepl:                                         ; preds = %9
  call void @llvm.lifetime.start.p0(i64 -1, ptr %.loc)
  %targetBlock = call i1 @main.extracted(ptr %11, ptr %5, ptr %.loc)
  %.reload = load i32, ptr %.loc, align 4
  call void @llvm.lifetime.end.p0(i64 -1, ptr %.loc)
  br i1 %targetBlock, label %42, label %31

31:                                               ; preds = %codeRepl, %31
  %32 = phi i32 [ %40, %31 ], [ 0, %codeRepl ]
  %33 = phi i32 [ %38, %31 ], [ 0, %codeRepl ]
  %34 = phi ptr [ %39, %31 ], [ %5, %codeRepl ]
  %35 = shl i32 %33, 7
  ...
  %40 = add nuw i32 %32, 1
  %41 = icmp eq i32 %40, %.reload
  br i1 %41, label %42, label %31, !llvm.loop !20

42:                                               ; preds = %codeRepl, %31
  %43 = phi i32 [ 0, %codeRepl ], [ %38, %31 ]
  %44 = icmp eq i32 %43, 244939252
  %45 = select i1 %44, ptr @str.3, ptr @str
  %46 = tail call i32 @puts(ptr nonnull %45)
  %47 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.2, i32 noundef %43)
  ret i32 0
}
...
define void @init_program() local_unnamed_addr #0 {
  %1 = tail call ptr @malloc(i32 noundef 24) #9
...
4:                                                ; preds = %4, %0
  ...
  %25 = icmp eq i32 %5, 0
  br i1 %25, label %4, label %codeRepl, !llvm.loop !16

codeRepl:                                         ; preds = %4
  call void @init_program.extracted()
  br label %.ret
...
define void @_5_bf_1(i64 noundef %0) local_unnamed_addr #5 {
  tail call void asm sideeffect "movq  $0, 8(%rbp)", "r,~{dirflag},~{fpsr},~{flags}"(i64 %0) #9, !srcloc !21
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define internal i1 @main.extracted(ptr %0, ptr %1, ptr %.out) #5 {
newFuncRoot:
  br label %2

2:                                                ; preds = %newFuncRoot
  %3 = getelementptr inbounds %struct._4_init_program_1_opaque_NodeStruct, ptr %0, i64 0, i32 1
  store ptr %0, ptr @_4_init_program_1_opaque_ptr_1, align 8, !tbaa !8
  br label %codeRepl

codeRepl:                                         ; preds = %2
  %targetBlock = call i1 @main.extracted.extracted(ptr %0, ptr %3, ptr %1, ptr %.out)
...
; Function Attrs: noinline nounwind uwtable
define internal i1 @main.extracted.extracted(ptr %0, ptr %1, ptr %2, ptr %.out) #5 {
newFuncRoot:
  br label %3

3:                                                ; preds = %newFuncRoot
  store ptr %0, ptr @_4_init_program_1_opaque_ptr_2, align 8, !tbaa !8
  %4 = load ptr, ptr %1, align 8, !tbaa !10
  store ptr %4, ptr @_4_init_program_1_opaque_ptr_2, align 8, !tbaa !8
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_program.extracted() #5 {
newFuncRoot:
  br label %0

0:                                                ; preds = %newFuncRoot
  %1 = load ptr, ptr @_4_init_program_1_opaque_list_1, align 8, !tbaa !8
  %2 = getelementptr inbounds %struct._4_init_program_1_opaque_NodeStruct, ptr %1, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !10
  br label %codeRepl

codeRepl:                                         ; preds = %0
  call void @init_program.extracted.extracted(ptr %3)
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_program.extracted.extracted(ptr %0) #5 {
newFuncRoot:
  br label %1
...
1:                                                ; preds = %newFuncRoot
  store ptr %0, ptr @_4_init_program_1_opaque_ptr_1, align 8, !tbaa !8
  store ptr %0, ptr @_4_init_program_1_opaque_ptr_2, align 8, !tbaa !8
  %2 = getelementptr inbounds %struct._4_init_program_1_opaque_NodeStruct, ptr %0, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !10
  store ptr %3, ptr @_4_init_program_1_opaque_ptr_2, align 8, !tbaa !8
