; ModuleID = '../unobfuscated_files/lcm/lcm.c'
source_filename = "../unobfuscated_files/lcm/lcm.c"
...
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 {
  ...
  %22 = call i32 @lcm(i32 noundef %20, i32 noundef %21)
  store i32 %22, i32* %9, align 4
  %23 = load i32, i32* %9, align 4
  %24 = icmp eq i32 %23, 120843912
  br i1 %24, label %25, label %27
...
29:                                               ; preds = %27, %25
  ...
  %31 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), i32 noundef %30)
  ret i32 0
}
