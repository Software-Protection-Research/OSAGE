; ModuleID = '../unobfuscated_files/celcius2fahrenheit/celcius2fahrenheit.c'
source_filename = "../unobfuscated_files/celcius2fahrenheit/celcius2fahrenheit.c"
...
define dso_local double @convertTemp(double noundef %0) #0 {
  %2 = alloca double, align 8
  %3 = alloca double, align 8
  store double %0, double* %2, align 8
  %4 = load double, double* %2, align 8
  %5 = fmul double %4, 9.000000e+00
  %6 = fdiv double %5, 5.000000e+00
  %7 = fadd double %6, 3.200000e+01
...
define dso_local i32 @main(i32 noundef %0, i8** noundef %1) #0 {
  ...
  %17 = call double @convertTemp(double noundef %16)
  %18 = fptoui double %17 to i32
  store i32 %18, i32* %8, align 4
  %19 = load i32, i32* %8, align 4
  %20 = icmp eq i32 %19, -1854930912
...
25:                                               ; preds = %23, %21
  ...
  %27 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i32 noundef %26)
  ret i32 0
}
