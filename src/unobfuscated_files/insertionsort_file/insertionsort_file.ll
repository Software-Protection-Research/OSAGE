; ModuleID = '../unobfuscated_files/insertionsort_file/insertionsort_file.c'
source_filename = "../unobfuscated_files/insertionsort_file/insertionsort_file.c"
...
76:                                               ; preds = %64
  ...
  store %struct._IO_FILE* %78, %struct._IO_FILE** %10, align 8
...
99:                                               ; preds = %85
  ...
  call void @insertionSort(i32* noundef %102, i32 noundef %103)
...
117:                                              ; preds = %113
  ...
  %123 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32 noundef %122)
  br label %124
...
127:                                              ; preds = %113
  %128 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i64 0, i64 0))
  ret i32 0
}
