...
3:                                                ; preds = %3, %1
  ...
  %14 = icmp eq i64 %13, 7
  br i1 %14, label %.preheader8, label %3, !llvm.loop !13

.preheader8:                                      ; preds = %3
  br label %15

15:                                               ; preds = %.preheader8, %29
  %16 = phi i64 [ %31, %29 ], [ 0, %.preheader8 ]
  ...
  br i1 %21, label %29, label %.preheader6

.preheader6:                                      ; preds = %15
  br label %22

22:                                               ; preds = %.preheader6, %22
  %23 = phi ptr [ %27, %22 ], [ %20, %.preheader6 ]
  ...
  br i1 %28, label %.loopexit7, label %22, !llvm.loop !16

.loopexit7:                                       ; preds = %22
  br label %29

29:                                               ; preds = %.loopexit7, %15
  %30 = tail call i32 @putchar(i32 10)
  %31 = add nuw nsw i64 %16, 1
  %32 = icmp eq i64 %31, 6
  br i1 %32, label %.preheader5, label %15, !llvm.loop !17

.preheader5:                                      ; preds = %29
  br label %33

33:                                               ; preds = %.preheader5, %74
  %34 = phi i64 [ %76, %74 ], [ 0, %.preheader5 ]
...
47:                                               ; preds = %67, %43
  ...
  br i1 %50, label %51, label %.preheader2
...
51:                                               ; preds = %47
  ...
  br i1 %54, label %.loopexit4, label %43, !llvm.loop !18

55:                                               ; preds = %.preheader2, %60
  %56 = phi ptr [ %58, %60 ], [ %44, %.preheader2 ]
...
67:                                               ; preds = %70, %63
  ...
  br i1 %69, label %.loopexit3, label %47, !llvm.loop !18
...
74:                                               ; preds = %.loopexit4, %.loopexit3, %38, %33
  %75 = phi ptr [ %36, %38 ], [ %36, %33 ], [ %44, %.loopexit3 ], [ %48, %.loopexit4 ]
...
81:                                               ; preds = %95, %78
  ...
  br i1 %87, label %95, label %.preheader1

.preheader1:                                      ; preds = %81
  br label %88

88:                                               ; preds = %.preheader1, %88
  %89 = phi ptr [ %93, %88 ], [ %86, %.preheader1 ]
  ...
  br i1 %94, label %.loopexit, label %88, !llvm.loop !16

.loopexit:                                        ; preds = %88
  br label %95

95:                                               ; preds = %.loopexit, %81
  %96 = tail call i32 @putchar(i32 10)
  %97 = add nuw nsw i64 %82, 1
  %98 = icmp eq i64 %97, 6
  br i1 %98, label %.preheader, label %81, !llvm.loop !21

.preheader:                                       ; preds = %95
  br label %99

99:                                               ; preds = %.preheader, %118
  %100 = phi i64 [ %120, %118 ], [ 0, %.preheader ]
  %101 = phi i32 [ %119, %118 ], [ 0, %.preheader ]
...
3:                                                ; preds = %.preheader, %3
  ...
  br i1 %9, label %.loopexit, label %3, !llvm.loop !16
...
16:                                               ; preds = %12
  ...
  br i1 %19, label %.loopexit1, label %8, !llvm.loop !18

20:                                               ; preds = %.preheader, %25
  %21 = phi ptr [ %23, %25 ], [ %9, %.preheader ]
...
33:                                               ; preds = %38, %30
  ...
  br i1 %35, label %.loopexit, label %12, !llvm.loop !18
...
42:                                               ; preds = %.loopexit1, %.loopexit, %3, %1
  %43 = phi ptr [ %0, %3 ], [ %0, %1 ], [ %9, %.loopexit ], [ %13, %.loopexit1 ]
  ret ptr %43
}
...
25:                                               ; preds = %2
  %26 = tail call i32 @puts(ptr nonnull @str.10)
  tail call void @exit(i32 noundef 1) #10
  unreachable

27:                                               ; preds = %46, %88, %24
  %28 = phi i64 [ 1, %24 ], [ %89, %88 ], [ 0, %46 ]
  %29 = getelementptr inbounds ptr, ptr %1, i64 %28
  %30 = load ptr, ptr %29, align 8, !tbaa !4
  %31 = add nsw i64 %28, -1
  %32 = getelementptr inbounds i32, ptr %6, i64 %31
  %33 = tail call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %30, ptr noundef nonnull @.str.6, ptr noundef nonnull %32) #11
  %34 = mul i64 %3, %3
  %35 = mul i64 %34, %3
  %36 = add i64 %35, %3
  %37 = srem i64 %36, 2
...
100:                                              ; preds = %100, %97
  ...
  %104 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %103)
  %105 = add nuw nsw i64 %101, 1
  %106 = icmp eq i64 %105, %99
  br i1 %106, label %.loopexit, label %100, !llvm.loop !26

.loopexit:                                        ; preds = %100
  br label %107

107:                                              ; preds = %.loopexit, %91
