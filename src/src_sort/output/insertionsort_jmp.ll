...
14:                                               ; preds = %14, %10
  ...
  br i1 %22, label %.loopexit2, label %14, !llvm.loop !14

.loopexit2:                                       ; preds = %14
  br label %23

23:                                               ; preds = %.loopexit2, %8
  %24 = add i32 %0, -1
  %25 = icmp sgt i32 %0, 2
...
42:                                               ; preds = %39, %32
  ...
  br i1 %48, label %.loopexit1, label %28, !llvm.loop !11

.loopexit1:                                       ; preds = %42
  br label %49

49:                                               ; preds = %.loopexit1, %23
...
57:                                               ; preds = %57, %55
  ...
  br i1 %63, label %.loopexit, label %57, !llvm.loop !15

.loopexit:                                        ; preds = %57
  br label %64

64:                                               ; preds = %.loopexit, %49
