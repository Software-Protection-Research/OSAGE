...
45:                                               ; preds = %.preheader, %45
  ...
  %51 = icmp eq i32 %50, 0
  br i1 %51, label %45, label %.loopexit2, !llvm.loop !16

.loopexit2:                                       ; preds = %45
  br label %52

52:                                               ; preds = %.loopexit2, %40
...
71:                                               ; preds = %69
  ...
  br i1 %73, label %.loopexit1, label %58, !llvm.loop !11

.loopexit1:                                       ; preds = %71
  br label %74

74:                                               ; preds = %.loopexit1, %52
...
82:                                               ; preds = %82, %80
  ...
  br i1 %88, label %.loopexit, label %82, !llvm.loop !17

.loopexit:                                        ; preds = %82
  br label %89

89:                                               ; preds = %.loopexit, %74
