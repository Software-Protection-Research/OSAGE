...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init5643790740366483276, ptr null }]
...
define void @decode16861440844875280785(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init5643790740366483276() {
...
15:                                               ; preds = %0
  call void @decode16861440844875280785(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
34:                                               ; preds = %15
  call void @decode16861440844875280785(ptr @.str.4, i32 4, ptr @.str.4, ptr %32, ptr %33)
...
113:                                              ; preds = %34
  call void @decode16861440844875280785(ptr @str, i32 28, ptr @str, ptr %111, ptr %112)
...
152:                                              ; preds = %113
  call void @decode16861440844875280785(ptr @str.6, i32 11, ptr @str.6, ptr %150, ptr %151)
...
191:                                              ; preds = %152
  call void @decode16861440844875280785(ptr @str.7, i32 9, ptr @str.7, ptr %189, ptr %190)
  ret void
}
