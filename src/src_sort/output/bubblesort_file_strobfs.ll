...
@llvm.global_ctors = appending constant [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @init1673656153332093970, ptr null }]
...
74:                                               ; preds = %71, %52
  %75 = load i32, ptr %35, align 4, !tbaa !4
  %76 = icmp eq i32 %75, 84
  %77 = select i1 %76, ptr @str.10, ptr @str
...
82:                                               ; preds = %82, %80
  ...
  %86 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.8, i32 noundef %85)
...
define void @decode5383548653430930241(ptr %0, i32 %1, ptr %2, ptr %3, ptr %4) {
  %6 = icmp sgt i32 %1, 0
...
define internal void @init1673656153332093970() {
...
15:                                               ; preds = %0
  call void @decode5383548653430930241(ptr @.str.1, i32 3, ptr @.str.1, ptr %13, ptr %14)
...
86:                                               ; preds = %15
  call void @decode5383548653430930241(ptr @.str.2, i32 21, ptr @.str.2, ptr %84, ptr %85)
...
101:                                              ; preds = %86
  call void @decode5383548653430930241(ptr @.str.3, i32 3, ptr @.str.3, ptr %99, ptr %100)
...
112:                                              ; preds = %101
  call void @decode5383548653430930241(ptr @.str.4, i32 2, ptr @.str.4, ptr %110, ptr %111)
...
127:                                              ; preds = %112
  call void @decode5383548653430930241(ptr @.str.5, i32 3, ptr @.str.5, ptr %125, ptr %126)
...
146:                                              ; preds = %127
  call void @decode5383548653430930241(ptr @.str.8, i32 4, ptr @.str.8, ptr %144, ptr %145)
...
185:                                              ; preds = %146
  call void @decode5383548653430930241(ptr @str, i32 11, ptr @str, ptr %183, ptr %184)
...
224:                                              ; preds = %185
  call void @decode5383548653430930241(ptr @str.10, i32 9, ptr @str.10, ptr %222, ptr %223)
  ret void
}
