...
echo "tigress --Environment=x86_64:Linux:Gcc:8.4 ${args} "/in_modified/${cfile}" --out="/out/${sample}.c""
tigress --Environment=x86_64:Linux:Gcc:8.4 ${args} "/in_modified/${cfile}" --out="/out/${sample}.c"
